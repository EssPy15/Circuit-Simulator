...
def main():
    ...
    matrix_impedance = get_matrix_impedance(values[2], values[3], values[4], s)
    ...
    Formats.format_result(inverse_laplace_transform(matrix_j_branch, s, t), inverse_laplace_transform(matrix_v_branch, s, t), branches_order)
